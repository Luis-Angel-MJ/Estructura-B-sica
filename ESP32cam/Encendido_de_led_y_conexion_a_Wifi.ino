...
// Datos de Red
const char* ssid = "Dark_King";  // Pon aquí el nombre de la red a la que deseas conectarte
const char* password = "Dixy_Gigi_MJ";  // Escribe la contraseña de dicha red
